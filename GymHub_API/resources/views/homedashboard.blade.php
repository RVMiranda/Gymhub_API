    ...
    <main>
        <div class="container">
            <section class="schedule-section">
                <h2>Horarios de clases grupales</h2>
            ...
            <section class="register-section">
                ...
                <form>
                    <label for="matricula">Ingresa tu matrícula:</label>
                    <input type="text" id="matricula" name="matricula" placeholder="7KS -292 I">
                    <button type="submit">Registrar &#10003;</button>
                </form>
                <div class="carousel">
                    <button class="carousel-prev">&#9664;</button>
                    <img src="gym-photo.jpg" alt="Gym Photo">
