    ...
    <main>
        <section class="vip-member-section">
            <div class="add-member">
                <label for="matricula">Ingresar la matrícula</label>
                <div class="matricula-input">
                    <input type="text" id="matricula" name="matricula" placeholder="H32182">
        ...
        <section class="classes-section">
            <div class="personal-classes">
                <h3>Próximas clases personalizadas</h3>
                <table>
                    <thead>
                        <tr>
                            <th>Inicio | Finalización</th>
                            <th>Miembro</th>
                            <th>Entrenamiento</th>
                        </tr>
                    </thead>
        ...
        {{-- <section class="assign-section">
            <form>
                ...
                <select id="entrenamiento" name="entrenamiento">
                    <option>Ganancia muscular C</option>
                    <!-- Otras opciones -->
                </select>
